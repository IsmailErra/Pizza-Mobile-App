...
public class ProduitService implements IDao<Produit> {
    ...
    private void seed() {
        ...
        data.add(new Produit("PESTO CHICKEN PIZZA", 3, R.mipmap.pizza6, "50 min",
                ...
                "STEP 2:\n\n  Turn onto a lightly floured surface; knead until smooth and elastic, about 6-8 minutes. Place in a bowl coated with cooking spray, turning once to coat top. Cover and let rise until doubled, about 1 hour.\n\n" +
        ...
        data.add(new Produit("PIZZA MARGHERITA", 1, R.mipmap.pizza9, "30 min",
                ...
                "STEP 2:\n\n  Turn onto a floured surface; knead until smooth and elastic, about 6-8 minutes. Place in a bowl coated with cooking spray, turning once to coat the top. Cover and let rise until doubled, about 1 hour.\n\n" +
